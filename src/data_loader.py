...
Module ini digunakan untuk memuat dataset dari direktori `data/` 
baik dari folder raw maupun processed untuk analisis keterlambatan pengiriman barang.
"""
...
def load_csv(filename, processed=False):
    ...
    Parameters:
        filename (str): Nama file (contoh: 'SCMS_Delivery_History_Dataset.csv')
...
if __name__ == "__main__":
    try:
        df = load_csv("SCMS_Delivery_History_Dataset.csv")  # Ganti sesuai nama file kamu
        preview_data(df)
